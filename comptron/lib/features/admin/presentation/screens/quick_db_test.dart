...
class QuickDBTest extends StatelessWidget {
  ...
  Future<void> _testConnection(BuildContext context) async {
    try {
      ...
      const mongoUri = 'mongodb+srv://oveisawesome_db_user:1rj2ogNr7hO7XUG0@cluster0.pkrk3ft.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0';
      ...
      await collection.insertOne({'test': 'Hello from Flutter!', 'timestamp': DateTime.now()});
      ...
      if (context.mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('✅ Connection successful! Document: ${result?['test']}'),
